[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/FupO3N9V)
...
```
$ ./passgen -h
-- Welcome to passgen v 1.0, © DIMAp --
...
```
$ ./passgen --len 10 --lower --upper --verbose
-- Welcome to passgen v 1.0, © DIMAp --

>>> The generated password is:
rwfBKARmqZ

>>> Variability (distinct characters in the password) is: 10
...
>>> Variability (distinct characters in the password) is: 15
